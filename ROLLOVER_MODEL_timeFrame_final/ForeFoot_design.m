...
P_max = 1200; % max force at the toe or heel
n = 0.9; % safty factor used to multiple with TS

%% design: (change here)
L=165/1000; % keel length 165 or 90

h_max = 4.191/1000;  % keel max thickness

n_h = 0.3245; % keel min thickness
h_min = 1.5/1000;%h_max*n_h;

n_c = 0.161; % h-constant part length
c = 26.57/1000;%L*n_c;

n_f = 0.257; % fulcrum farest position
a_max = 158.17/1000;%L-c*n_f; 
